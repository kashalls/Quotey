...
module.exports = {
	...
	async execute(interaction) {
		...
		if (subcommand === 'show') {
			...
			interaction.reply(`Successfully set your ${subgroup} channel to <#${subCommandChannel.id}> (ID: ${subCommandChannel.id}).`);
		}
		return interaction.reply('Not sure what to do. :thinking:');
	}
};
